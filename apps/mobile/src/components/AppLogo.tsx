 ...
 *    symptom beyond a console violation. At 64 KB this one is safe; a
 *    small asset added later would not be.
 *
 * Only the light variant ships: mobile pins `data-theme="light"` for v1,
 * so unlike desktop's `AppLogo` there is no second `<img>` and no CSS
 * switch. Sized by height with `width: auto` — the artwork is not square
